...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference('Contum.count') do
      post conta_url, params: { contum: { data_abertura: @contum.data_abertura, data_encerramento: @contum.data_encerramento, numero: @contum.numero, saldo: @contum.saldo, tipo: @contum.tipo } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { data_abertura: @contum.data_abertura, data_encerramento: @contum.data_encerramento, numero: @contum.numero, saldo: @contum.saldo, tipo: @contum.tipo } }
